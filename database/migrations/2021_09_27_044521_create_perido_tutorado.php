...
class CreatePeridoTutorado extends Migration
{
    ...
    public function up()
    {
        Schema::create('periodo_tutorado', function (Blueprint $table) {
            ...
            $table->integer('tipo');
            $table->longText('mes_1')->nullable();
            $table->longText('mes_2')->nullable();
            $table->longText('mes_3')->nullable();
            $table->longText('mes_4')->nullable();
            $table->longText('reporte_final')->nullable();
            $table->longText('oe_1')->nullable();
            $table->longText('oe_2')->nullable();
            $table->longText('oe_3')->nullable();
            $table->longText('oe_4')->nullable();
