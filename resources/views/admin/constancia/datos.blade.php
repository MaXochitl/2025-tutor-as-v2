                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row" style="width: 20px;">
                                ...
                                data-bs-target="#datos-constancia{{ $datos[0]->id }}">
                                ...
                                @include('modal.constancias.constancia', ['item' => $datos[0]])
                            </th>
                            <td>{{ $datos[0]->nombre_archivo }}</td>
                            <td>{{ $datos[0]->destinatario }}</td>
                        ...
                        <tr>
                            <th scope="row" style="width: 20px;">
                                <a style="color: white" class="btn btn-warning"
                                data-bs-toggle="modal"
                                data-bs-target="#datos-constancia{{ $datos[1]->id }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                                            class="bi bi-pencil-square" viewBox="0 0 16 16">
                                            <path
                                                d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                ...
                                @include('modal.constancias.memorandum', ['item' => $datos[1]])
                            </th>
                            <td>{{ $datos[1]->nombre_archivo }}</td>
                            <td>{{ $datos[1]->destinatario }}</td>
                            <td>{{ $datos[1]->atentamente_1 }}</td>
                            <td>{{ $datos[1]->cargo }}</td>
                            <td>{{ $datos[1]->atentamente_2 }}</td>
                            <td>{{ $datos[1]->cargo_2 }}</td>
                            <td class="text-muted casilla bloqueada"></td>
                            <td class="text-muted casilla bloqueada"></td>
                        </tr>
                    </tbody>
                </table>
