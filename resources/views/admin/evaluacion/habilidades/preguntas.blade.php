        ...
        <div class="row ">
            ...
            <div class="col d-flex flex-column flex-shrink-0" style="padding: 20px;">
                <div style="text-align: center">
                    <h1>
                        PREGUNTAS RAZONAMIENTO <br> Y HABILIDADES MENTALES
                    </h1>
                </div>
                <div class="p-2">
                    <a href="{{ route('habilidades.create') }} " type="button" class="btn btn-primary">
                            ...
                            @foreach ($preguntas as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('habilidades.destroy', $item->id) }} " method="POST">
                                            @csrf
                                            @method('DELETE')
