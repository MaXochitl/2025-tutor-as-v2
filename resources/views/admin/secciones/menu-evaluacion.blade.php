    ...
    <div id="sidebar" class="sidebar">
        ...
        <ul class="menu">
            <li><a class="enlaces" href="#">
                    ...
                    Evaluacion <svg class="icono derecha" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        fill="currentColor" class="bi bi-chevron-compact-down" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                            d="M1.553 6.776a.5.5 0 0 1 .67-.223L8 9.44l5.776-2.888a.5.5 0 1 1 .448.894l-6 3a.5.5 0 0 1-.448 0l-6-3a.5.5 0 0 1-.223-.67z" />
                    </svg> </a>
                <ul>
                    <li><a class="enlaces" href="{{ route('login') }}">Evaluacion</a></li>
            ...
            <li><a class="enlaces" href="#">
                ...
                <ul>
                    <li><a class="enlaces" href="#">Tutor</a></li>
                    <li><a class="enlaces" href="#">Alumno</a></li>
                    <li><a class="enlaces" href="#">Usuario</a></li>
                    <li><a class="enlaces" href="#">Nota</a></li>
                    <li><a class="enlaces" href="#">Periodo</a></li>
                </ul>
            </li>
            ...
            <li><a class="enlaces" href="#">
                ...
                <ul>
                    <li><a class="enlaces" href="#">Tutores</a></li>
                    <li><a class="enlaces" href="#">Alumnos</a></li>
                    <li><a class="enlaces" href="#">Usuarios</a></li>
                    <li><a class="enlaces" href="#">Notas</a></li>
                    <li><a class="enlaces" href="#">Periodos</a></li>
                </ul>
            </li>
