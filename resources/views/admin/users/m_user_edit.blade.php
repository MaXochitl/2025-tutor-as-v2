<div class="modal fade" id="m-user-edit{{ $user->id }}" tabindex="-1" aria-labelledby="user-e-modal"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4>
                    Editar: {{ $user->tutor->nombre.' '. $user->tutor->ap_paterno. ' '. $user->tutor->ap_paterno}}
                </h4>
                @if (count($errors) > 0)
                ...
                <form method="POST" action="{{ route('usersAdmin.update', $user->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="carrera" class="form-label">Rol</label>
