<div class="row row-tutor">
    ...
    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#jefeDepartamentoModal">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalFormularioLabel">Canalización</h5>
                ...
                <div id="formContent">
                    <form id="formAlumno" method="POST" action="{{ route('atenciones.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="area_canalizada" id="area_canalizada" class="form-control">
                        </div>
...
<div class="modal fade" id="jefeDepartamentoModal" tabindex="-1" aria-labelledby="jefeDepartamentoModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('reporte.pdf', ['id' => $tutor->id]) }}" method="GET" target="_blank">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="jefe_departamento" class="form-label">Nombre del Jefe del Departamento</label>
                        <input type="text" name="jefe_departamento" id="jefe_departamento" class="form-control" required>
                    </div>
                </div>
            ...
            fetch(`/atenciones/${alumnoId}`)
                ...
                .then(data => {
                    ...
                    if (document.getElementById("area_canalizada")) {
                        document.getElementById("area_canalizada").value = data.area_canalizada || "";
                    }
                })
                .catch(error => {
