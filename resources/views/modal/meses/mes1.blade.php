<div class="modal fade" id="month1Modal{{$alumnos->id}}" tabindex="-1"
    aria-labelledby="month1ModalLabel{{$alumnos->id}}" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content shadow border-0">
            ...
            <div class="modal-header bg-light">
                <h5 class="modal-title d-flex align-items-center gap-2" id="month1ModalLabel{{$alumnos->id}}">
                ...
                <form method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="seguimiento"
                            ...
                            placeholder="Escribe aquí el seguimiento del alumno...">{{ $alumnos->mes_1 }}</textarea>
                    </div>
