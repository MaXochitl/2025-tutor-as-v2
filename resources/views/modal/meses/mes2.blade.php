<div class="modal fade" id="month2Modal{{ $alumnos->id }}" tabindex="-1" aria-labelledby="monthModal"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content text-center"><!--texto centrado-->
            <div class="modal-header">
                <h5 class="modal-title" id="month2Modal{{ $alumnos->id }}">
                    Alumno
            ...
            <div class="modal-body">
                ...
                <form id="formUpdate" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input name="seguimiento" type="text" class="form-control" value="{{ $alumnos->mes_2 }}">
                    </div>
