<div class="modal fade" id="month4Modal{{$alumnos->id}}" tabindex="-1"
    aria-labelledby="month4ModalLabel{{$alumnos->id}}" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content shadow border-0">
            ...
            <div class="modal-header bg-light">
                <h5 class="modal-title d-flex align-items-center gap-2" id="month4ModalLabel{{$alumnos->id}}">
            ...
            <div class="modal-body p-4">
                ...
                <form method="POST"
                    action="{{ route('seguimiento-alumno.seguimiento', [$alumnos->id, 4]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="seguimiento"
                            ...
                            placeholder="Escribe aquí el seguimiento del alumno...">{{ $alumnos->mes_4 }}</textarea>
                    </div>
