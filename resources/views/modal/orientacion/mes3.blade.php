<div class="modal fade" id="oe3Modal{{$alumnos->id}}" tabindex="-1"
    aria-labelledby="oe3ModalLabel{{$alumnos->id}}" aria-hidden="true">
        ...
        <div class="modal-content shadow-lg border-0">
            ...
            <div class="modal-body p-4">
                ...
                <form id="formUpdate" method="POST"
                    action="{{ route('seguimientoOE-alumno.seguimientoOE', [$alumnos->id, 3]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea
                            ...
                            style="resize: vertical; min-height: 120px;">{{ $alumnos->oe_3 }}</textarea>
                    </div>
