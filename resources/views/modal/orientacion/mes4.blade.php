<div class="modal fade" id="oe4Modal{{ $alumnos->id }}" tabindex="-1" aria-labelledby="oe4Modal"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="oe4Modal{{ $alumnos->id }}">
                    Alumno:
            ...
            <div class="modal-body">
                ...
                <form id="formUpdate" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="seguimiento" type="text" class="form-control">{{ $alumnos->oe_4 }}</textarea>
                    </div>
